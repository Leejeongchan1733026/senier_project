                    ...
                    <div class="article-box">
                        ...
                        <div class="a-box-info">
                            <div class="a-box-title">
                                <h1 class="product"><%=list.get(i).getPOST_TITLE()%></h1>
                            ...
                            <div class="a-box-under">
                                <a href= <%= postDetail%> >
                                   ...
                                   <a href= "reserveDeleteAction.jsp?reserveID=<%=list.get(i).getRESERVE_NUM()%>" >
                                   		<button onclick="return confirm('정말로 취소하시겠습니까?')" class="moreBtn" style="background-color:red; color:white" ><p>예약취소</p></button>
                                   	</a>
                            </div>
                        </div>
                    </div>
